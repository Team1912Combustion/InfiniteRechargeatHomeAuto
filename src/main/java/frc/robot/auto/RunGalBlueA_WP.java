...
public class RunGalBlueA_WP extends SequentialCommandGroup {
  ...
  public RunGalBlueA_WP(DriveTrain drivetrain, Intake intake) {

    String myPathName = "";
    String trajectoryfile = "";

    myPathName = "GalBlueA_WP";
    ...
    trajectory = TrajectoryGenerator.generateTrajectory(
      ...
      List.of( new Translation2d(2.3 , -3.0),
        new Translation2d(4.4 , -3.8),
        new Translation2d(5.2 , -1.5),
        new Translation2d(6.7 , -2.2)),
      new Pose2d(8.8, -2.3, new Rotation2d(Units.degreesToRadians(0))),
      config);

...
public class RunGalRedA_WP extends SequentialCommandGroup {
  ...
  public RunGalRedA_WP(DriveTrain drivetrain, Intake intake) {

    String myPathName = "";
    String trajectoryfile = "";

    myPathName = "GalRedA_WP";
    ...
    trajectory = TrajectoryGenerator.generateTrajectory(
      ...
      List.of( new Translation2d(2.1 , -2.3),
        new Translation2d(3.3 , -1.6),
        new Translation2d(3.6 , -3.1),
        new Translation2d(4.4 , -0.8)),
      new Pose2d(8.8, -2.3, new Rotation2d(Units.degreesToRadians(-45.))),
      config);
